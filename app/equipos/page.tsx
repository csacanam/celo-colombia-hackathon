...
const PAGE_DESCRIPTION =
  "Todo lo que necesitas para presentar tu proyecto: rúbrica, pitch, demo y formulario. El formulario cierra el viernes 19 de junio a las 4:00 PM (hora Colombia).";
...
const FINAL_TIPS = [
  ...
  "Llena el formulario antes del cierre · viernes 19 de junio · 4:00 PM.",
];
