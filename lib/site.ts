...
/**
 * Cierre de entregas para Demo Day · viernes 19 de junio a las 4:40 PM (Colombia, UTC-5).
 * Pasado este momento el form se cierra (cliente) y el endpoint rechaza (server).
 */
export const SUBMIT_DEADLINE_ISO = "2026-06-19T16:40:00-05:00";
export const SUBMIT_DEADLINE_LABEL =
  "Viernes 19 de junio · 4:40 PM (hora Colombia)";
